        ...
        style={{
          ...
          <Card style={{width:"36.25vw",height:"18vh", boxShadow:"0px 0px 5px silver" ,marginLeft:"3%",display:"flex", borderRadius:"15px" ,flexDirection:"column", alignItems:"center"}}> 
            ...
            <div>
              ...
              <Link to="patient?page=1&sort=id,asc" 
                style={{
                  display:"flex",
                  alignItems:"center",
                  fontSize:"5px",
          ...
          <Button 
            ...
            <div>
              ...
              <Link to="/consultation?page=1&sort=id,asc" 
                style={{
                  display:"flex",
                  alignItems:"center",
                  fontSize:"5px",
          ...
          <Button 
            ...
            <div>
              ...
              <Link to="/bill?page=1&sort=id,asc" 
                style={{
                  display:"flex",
                  alignItems:"center",
                  fontSize:"5px",
          ...
          <Card style={{height:"30vh", width:"40vw", borderRadius:"15px",  boxShadow:"0px 0px 5px silver",marginLeft:"3vw"}}>
            <div style={{marginTop:"1%",fontSize:"15px", marginLeft:"3%", marginBottom:"1%",color:"#11485C", display:"flex",flexDirection:"row",gap:"60%"}}>
