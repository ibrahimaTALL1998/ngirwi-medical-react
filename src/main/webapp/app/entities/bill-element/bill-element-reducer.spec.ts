...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLELEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BILLELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILLELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILLELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILLELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILLELEMENT actions', async () => {
      const expectedActions = [
        {
