...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './surveillance-sheet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SURVEILLANCESHEET_LIST actions', async () => {
    ...
    it('dispatches FETCH_SURVEILLANCESHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SURVEILLANCESHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SURVEILLANCESHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SURVEILLANCESHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SURVEILLANCESHEET actions', async () => {
      const expectedActions = [
        {
