...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './medecine.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDECINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEDECINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEDECINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEDECINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEDECINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEDECINE actions', async () => {
      const expectedActions = [
        {
