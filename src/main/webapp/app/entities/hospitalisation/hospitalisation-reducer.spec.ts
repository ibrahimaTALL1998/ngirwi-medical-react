...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOSPITALISATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOSPITALISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOSPITALISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOSPITALISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOSPITALISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOSPITALISATION actions', async () => {
      const expectedActions = [
        {
