...
export const Hospitalisation = () => {
  ...
  return (
    <div>
      <h2 id="hospitalisation-heading" data-cy="HospitalisationHeading">
        Hospitalisations
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} /> Actualiser la liste
          </Button>
          <Link to="/hospitalisation/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp; Créer un nouveau Hospitalisation
          </Link>
        </div>
      </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('entryDate')}>
                  Entry Date <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {hospitalisationList.map((hospitalisation, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/hospitalisation/${hospitalisation.id}`} color="link" size="sm">
                      {hospitalisation.id}
                    </Button>
                  </td>
                  <td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/hospitalisation/${hospitalisation.id}`} color="info" size="sm" data-cy="entityDetailsButton">
      ...
      {totalItems ? (
        <div className={hospitalisationList && hospitalisationList.length > 0 ? '' : 'd-none'}>
