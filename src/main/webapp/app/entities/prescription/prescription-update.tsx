...
export const PrescriptionUpdate = () => {
  ...
  let infosPatient = () => {
    ...
    consultations.map(otherEntity => (otherEntity.id.toString() === consul) ? (
    ...
    <Document>
      <Page style={{ display: "flex", flexDirection: "column" ,fontFamily:"Poppins"}}>
        ...
        <View style={{ display: "flex", flexDirection: "column", justifyContent: 'space-around', alignItems: "center", marginTop: "15px" }}>
          ...
          <Text style={{ fontSize: "18px", marginBottom: "9px" }}> Fait à: ...................... Le: {convertDateTimeFromServerToDate(displayDefaultDateTime()) + ' à ' + convertDateTimeFromServerToHours(displayDefaultDateTime())}</Text>
          <Text style={{ fontSize: "18px", marginBottom: "7px" }}>Nom et Prénom(s): {prescriptionEntity.consultation?(prescriptionEntity?.consultation?.patient?.lastName.toUpperCase()+' '+prescriptionEntity?.consultation?.patient?.firstName):(p)} </Text>
        </View>
        <View style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: "15px", border: "3px solid silver", marginLeft: "10vw", marginRight: "5vw", width: "80vw" }}>
          <View style={{ display: "flex", flexDirection: "row", justifyContent: 'center', alignItems: "center" }}>
            <Text style={{ width: "40vw", borderRight: "3px solid silver", textTransform: "uppercase", fontSize: "15px", color: "green", paddingTop: "3px", paddingBottom: "5px", textAlign: "center" }}>Médicament(s)</Text>
            <Text style={{ width: "20vw", textTransform: "uppercase", fontSize: "15px", color: "green", paddingTop: "3px", paddingBottom: "5px", textAlign: "center" }}>Durée</Text>
            <Text style={{ width: "20vw", borderLeft: "3px solid silver", textTransform: "uppercase", fontSize: "15px", color: "green", paddingTop: "3px", paddingBottom: "5px", textAlign: "center" }}>Fréquence</Text>
          </View>
          {formValues.map((element,i) => element.medecine.length > 0  ? (
            <View key={`entity-${i}`} style={{ display: "flex", flexDirection: "row", justifyContent: 'center', alignItems: "center" }}>
              <Text style={{ width: "40vw",minHeight:"4vh", borderRight: "3px solid silver", borderTop: "3px solid silver", fontSize: "15px", paddingTop: "5px", paddingBottom: "3px", textAlign: "center" }}>{element.medecine}</Text>
              <Text style={{ width: "20vw",minHeight:"4vh", borderTop: "3px solid silver", fontSize: "15px", paddingTop: "5px", paddingBottom: "3px", textAlign: "center" }}>{element.duration} Jours</Text>
              <Text style={{ width: "20vw",minHeight:"4vh", borderTop: "3px solid silver", borderLeft: "3px solid silver", fontSize: "15px", paddingTop: "5px", paddingBottom: "3px", textAlign: "center" }}>{element.frequency} /J</Text>
            </View>
          ) : (
            // <View key={`entity-${i}`} style={{ display: "flex", flexDirection: "row", justifyContent: 'center', alignItems: "center" }}>
    ...
    >
      ...
      >
        ...
        >
          ...
          <span>Enregistrement nouvelle ordonnance</span>
        </Card>
        <Card
          style={{
            minHeight: "70vh",
        ...
        >
          ...
          >
            <span style={{ marginLeft: "3%", color: "#141414", fontSize: "19px", }}>Nouvelle ordonnance patient</span>
              ...
              >
                {({ loading }) =>
                  loading ? (
                    ...
                    <Button style={{ borderRadius: "25px" }} color='primary'>Télécharger l&apos;ordonnance</Button>
                  )
                }
              </PDFDownloadLink>
            </div>
          ...
          <ValidatedForm
            ...
            <ValidatedField onChange={(b) => handleConsulChange(b)} style={isNew ? { borderRadius: "25px", borderColor: "#CBDCF7" } : { borderRadius: "25px", backgroundColor: "#A9B7CD", borderColor: "#CBDCF7", color: "#F6FAFF" }} disabled={isNew ? false : true} id="prescription-consultation" name="consultation" data-cy="medecine" label="Consultation" type="select">
              <option value="" key="0" />
              {consultations
                ? consultations.map(otherEntity => (
                  <option value={otherEntity.id} key={otherEntity.id}>
                    Faite le  {convertDateTimeFromServerToDate(otherEntity.dateTime)} à {otherEntity.patient.lastName.toUpperCase()} {otherEntity.patient.firstName}
                  </option>
                ))
                : null}
            </ValidatedField>
