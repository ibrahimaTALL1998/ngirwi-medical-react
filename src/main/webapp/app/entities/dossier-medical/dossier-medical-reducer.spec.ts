...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOSSIERMEDICAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOSSIERMEDICAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOSSIERMEDICAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOSSIERMEDICAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOSSIERMEDICAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOSSIERMEDICAL actions', async () => {
      const expectedActions = [
        {
