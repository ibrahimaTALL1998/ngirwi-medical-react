      ...
      >
        ...
        >
              <div style={{display:"flex",flexDirection:"row",marginTop:"1%"}}>
                  <span style={{ color:"#141414",fontSize:"20px", marginLeft:"3%", marginBottom:"1%",width:"45vw"}}>Dossiers médicaux enregistrés</span>
                  ...
                  >
                    ...
                    <ValidatedField  style={{borderRadius:"12px",width:"17vw"}} placeholder="Barre de recherche" id="search" name="search" type={(criteria === "dateCreated" || criteria === "dateUpdated"  )? "date" : "text"}  onChange={handleSearch} />
          ...
          >
           <thead style={{
              ...
              <tr >
                ...
                <th style={{
                    ...
                    width: "15%",
                    backgroundColor: "white",
                  }} className="hand" onClick={sort('dateCreated')}>
                ...
                <th style={{
                    ...
                    width: "15%",
                    backgroundColor: "white",
                  }} className="hand" onClick={sort('dateUpdated')}>
           ...
           <tbody
            ...
            >
              {filter === null ? dossierMedicalList.map((dossierMedical, i) => (
                ...
                <td style={{wordBreak:"break-all"}}>
                  {dossierMedical.patient ? <span>{dossierMedical.patient.lastName.toUpperCase()+' '+dossierMedical.patient.firstName}</span> : ''}
                </td>
